...
Keep props and state focused on the data an island needs to attach. Island payloads are visible in the page source
and should never contain credentials or other secrets.
